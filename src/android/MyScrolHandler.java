...
public class MyScrolHandler extends RelativeLayout implements ScrollHandle {
    ...
    public MyScrolHandler(Context context, ScrollEndListener scrollEndListener) {
        this(context, scrollEndListener, false);
    }

    public MyScrolHandler(Context context, ScrollEndListener scrollEndListener, boolean inverted) {
        super(context);
    ...
    public void setupLayout(PDFView pdfView) {
        ...
        if (pdfView.isSwipeVertical()) {
            ...
            if (inverted) { // left
                ...
                background = ContextCompat.getDrawable(context, com.github.barteksc.pdfviewer.R.drawable.default_scroll_handle_left);
            } else { // right
            ...
            if (inverted) { // top
                ...
                background = ContextCompat.getDrawable(context, com.github.barteksc.pdfviewer.R.drawable.default_scroll_handle_top);
            } else { // bottom
    ...
    private void calculateMiddle() {
        ...
        //detect if bottom of file reached
        if(((pos + relativeHandlerMiddle) / pdfViewSize) == 1.0){
            scrollEndListener.onBottomOfScrollReached();
        }
